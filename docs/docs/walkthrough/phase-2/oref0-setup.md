...
* how you are getting CGM data.  The options are `g4` (default), `g4-raw`, `g5`, `mdt`, `shareble`, and `xdrip`.  Note:  OpenAPS will also attempt to get BG data from your Nightscout.  OpenAPS will always use the most recent BG data regardless of the source.
